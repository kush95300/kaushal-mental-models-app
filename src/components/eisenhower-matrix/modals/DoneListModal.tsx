...
export const DoneListModal: React.FC<DoneListModalProps> = ({
  ...
  <div className="fixed inset-0 z-[50200] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-md animate-in fade-in duration-300">
    <div className="bg-white dark:bg-slate-900 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 w-[calc(100%-2rem)] max-w-2xl max-h-[85vh] flex flex-col shadow-2xl border border-white dark:border-slate-800 animate-in zoom-in-95 duration-500 transition-colors">
      ...
      <div className="space-y-2 overflow-y-auto custom-scrollbar pr-2 font-sans flex-1 max-h-[55vh]">
